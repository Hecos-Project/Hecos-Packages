...
def backup_hpm_configs(app) -> dict | None:
    return _call_internal(app, "GET", "/hecos/api/backup_module/hpm_configs/backup")


def restore_hpm_configs(app, data: dict) -> dict:
    resp = _call_internal(app, "POST", "/hecos/api/backup_module/hpm_configs/restore", data)
    return resp or {"ok": False, "error": "No response from hpm_configs restore"}
...
def get_backup_fns() -> dict:
    ...
    fns = {
        ...
        "hpm_configs":  backup_hpm_configs,
    }
...
def get_restore_fns() -> dict:
    ...
    fns = {
        ...
        "hpm_configs":  restore_hpm_configs,
    }
...
def get_backup_metadata() -> dict:
    ...
    meta = {
        ...
        "hpm_configs":  {"label": "HPM Packages Config", "icon": "📦"},
    }
