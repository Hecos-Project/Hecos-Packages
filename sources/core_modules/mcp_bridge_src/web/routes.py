...
from hecos.modules.mcp_bridge.plugin.config_manager import get_config as _get_mcp_config, save_config as _save_mcp_config

def init_plugin_routes(app, cfg_mgr=None, hecos_root=None, logger=None):
    if logger is None:
