...
def init_routes(app, root_dir: str = None):
    ...
    try:
        from hecos.hpm.calendar.calendar_config.config_manager import get_calendar_config, save_calendar_section as save_calendar_config
    except ImportError:
    ...
    def calendar_create_event():
        ...
        try:
            ...
            if remind and not all_day:
                ...
                try:
                    from hecos.hpm.reminder import store as r_store, scheduler as r_sched
    ...
    def calendar_manual_sync():
        try:
            from hecos.hpm.calendar import sync_manager
